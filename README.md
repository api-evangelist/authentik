...
**APIs.json:** [https://raw.githubusercontent.com/api-evangelist/authentik/refs/heads/main/apis.yml](https://raw.githubusercontent.com/api-evangelist/authentik/refs/heads/main/apis.yml)
...
- **Base URL:** `https://your-authentik-instance.example.com/api/v3`
...
- [OpenAPI](https://api.goauthentik.io/#/Schema/schema_retrieve) — [OpenAPI Specification](https://spec.openapis.org/oas/latest.html)
- [API Reference](https://api.goauthentik.io/)
...
- [Postman Collection](collections/authentik.postman_collection.json) — [Postman Collection 2.1](https://schema.getpostman.com/json/collection/v2.1.0/collection.json)
- [Open Collection](collections/authentik.opencollection.json) — [Open Collection 1.0](https://schema.opencollection.com/opencollection/v1.0.0.json)

## Common Properties

- [LinkedIn](https://www.linkedin.com/company/authentik-security)
- [Website](https://goauthentik.io)
- [Documentation](https://docs.goauthentik.io)
- [GitHub Organization](https://github.com/goauthentik)
- [GitHub Repository](https://github.com/goauthentik/authentik)
